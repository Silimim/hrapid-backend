...
func newEmployee(db *gorm.DB, opts ...gen.DOOption) employee {
	...
	_employee.Phone1 = field.NewString(tableName, "phone1")
	_employee.Phone2 = field.NewString(tableName, "phone2")
	_employee.Email1 = field.NewString(tableName, "email1")
	_employee.Email2 = field.NewString(tableName, "email2")
	_employee.Role = field.NewString(tableName, "role")
	_employee.DateAdded = field.NewTime(tableName, "date_added")
	_employee.UserAddedID = field.NewInt32(tableName, "user_added_id")
...
func (e *employee) updateTableName(table string) *employee {
	...
	e.Phone1 = field.NewString(table, "phone1")
	e.Phone2 = field.NewString(table, "phone2")
	e.Email1 = field.NewString(table, "email1")
	e.Email2 = field.NewString(table, "email2")
	e.Role = field.NewString(table, "role")
	e.DateAdded = field.NewTime(table, "date_added")
	e.UserAddedID = field.NewInt32(table, "user_added_id")
...
func (e *employee) fillFieldMap() {
	...
	e.fieldMap["phone1"] = e.Phone1
	e.fieldMap["phone2"] = e.Phone2
	e.fieldMap["email1"] = e.Email1
	e.fieldMap["email2"] = e.Email2
	e.fieldMap["role"] = e.Role
	e.fieldMap["date_added"] = e.DateAdded
	e.fieldMap["user_added_id"] = e.UserAddedID
}
